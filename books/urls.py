...
urlpatterns = [
    ...
    path("books/<int:pk>/permanent-delete/",views.BookPermanentDeleteView.as_view(), name="book-permanent-delete",),

    
    path("borrows/",views.BorrowListView.as_view(),name="borrow-list",),
    path("borrows/create/",views.BorrowCreateView.as_view(),name="borrow-create",),
    # path("borrows/<int:pk>/update/", views.BorrowUpdateView.as_view(), name="borrow-update", ),
    path("borrows/<int:pk>/approve/",views.BorrowApproveView.as_view(),name="borrow-approve",),
    path("borrows/<int:pk>/return/",views.BorrowReturnView.as_view(),name="borrow-return",),
    path("my-borrows/",views.MyBorrowListView.as_view(), name="my-borrows",),
    path("borrow/cancel/<int:pk>/",views.BorrowCancelView.as_view(), name="borrow-cancel",),
    
    
    path("dashboard/",views.DashboardView.as_view(),name="dashboard",),
    path("dashboard/books/",views.AdminBookListView.as_view(),name="admin-book-list",),
    path("dashboard/borrows/",views.AdminBorrowListView.as_view(),name="admin-borrow-list",),
    path("dashboard/authors/",views.AdminAuthorListView.as_view(),name="admin-author-list",),
    path("dashboard/publishers/",views.AdminPublisherListView.as_view(),name="admin-publisher-list",),
